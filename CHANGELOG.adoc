...
* add :postprocess callback option to `convert` and `convert_file` APIs (#53)

=== Changed

* automatically set idprefix, if necessary, based on value of :auto_id_prefix option when :auto_ids options is set
